...
if ( ! class_exists( 'Home_Services_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Home_Services_Slider_Control extends Wp_Customize_Control {

		public $type = 'home-services-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'home-services-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'home-services-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
